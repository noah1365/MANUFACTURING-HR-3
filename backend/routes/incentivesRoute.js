...
incentiveRoute.post("/create-incentives",verifyToken,checkRole('Admin'),createIncentive);
incentiveRoute.get("/get-incentives",verifyToken,getIncentive);
incentiveRoute.put("/update-incentives/:id",verifyToken,checkRole('Admin'),updateIncentive);
incentiveRoute.delete("/delete-incentives/:id",verifyToken,checkRole('Admin'),deleteIncentive);
...
incentiveRoute.get("/get-all-employee-sales-status", verifyToken,getAllEmployeeSalesStatus );
